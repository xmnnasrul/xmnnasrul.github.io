...
!(function(t, e) {
    ...
    function se(t, e, i) {
        ...
        return (
            (a || (!a && !i)) &&
            (("body" !== lt(e) || Ut(o)) && (l = (n = e) !== ct(n) && ht(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : qt(n)), ht(e) ? (((c = mt(e)).x += e.clientLeft), (c.y += e.clientTop)) : o && (c.x = zt(o))), { x: r.left + l.scrollLeft - c.x, y: r.top + l.scrollTop - c.y, width: r.width, height: r.height }
        );
    }
