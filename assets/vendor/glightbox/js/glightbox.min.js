                    ...
                    if (r && ((P = s.targetTouches[0]), !b && !S)) {
                        ...
                        if (
                            (Math.abs(u) > Math.abs(m) ? ((L = !1), (I = !0)) : ((I = !1), (L = !0)),
                                ...
                                I && ((h = 1 - Math.abs(t) / l), (g.style.opacity = h), e.settings.touchFollowAxis && (A = 0)), !f)
                        )
                ...
                n(e, [{
                        ...
                        value: function() {
                            ...
                            if (
                                ...
                                if ("external" !== o)
                                    return "inline" === o ?
                                        (G.apply(this.instance, [t, s, this.index, v]), void(n.draggable && new V({ dragEl: t.querySelector(".gslide-inline"), toleranceX: n.dragToleranceX, toleranceY: n.dragToleranceY, slide: t, instance: this.instance }))) :
                                        void("image" !== o ?
                                            T(v) && v() :
                ...
                n(e, [{
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this,
                                t = [];
                            (this.elements = this.elements ? this.elements : []), !I(this.settings.elements) &&
